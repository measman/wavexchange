...
<head>
    ...
    <title>WAVE | <?= $this->renderSection('title'); ?></title>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="account_settings" style="left: -2.5em;">
                        ...
                        <a class="dropdown-item" href="<?= base_url(); ?>logout" id="acc-logout"><i
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                    style="opacity: .8">
                <span class="brand-text font-weight-light">WAVE</span>
            </a>
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="/transaction" class="nav-link">
                                <p><i class="nav-icon fas fa-tachometer-alt"></i> Transaction</p>
                            </a>
                        </li>
                    </ul>
                </nav>
